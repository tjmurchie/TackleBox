...
def _build_run_report(
    ...
    lines += [
        "    metamerge_merged_support.xlsx   — workbook with classification",
        "    metamerge_merged_support.tsv    — tab-separated text",
        "    run_summary.json                — machine-readable summary",
        "    warnings.tsv                    — run warnings",
        "    report_inputs/                  — long-format tables for heatmaps",
        "    reports/run_report.txt          — this report",
        "    common_name_cache.json          — cached GBIF lookups (if online)",
        "",
        "TIMING",
        _SEP2,
